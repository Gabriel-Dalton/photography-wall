...
// Get image data (without dimensions - simpler!)
function getImageData(filePath) {
    try {
        ...
        return {
            src: relativePath,
            w: null,  // Will be determined by browser
            h: null,  // Will be determined by browser
...
async function generateGallery() {
    ...
    for (const filePath of imageFiles) {
        const imageData = getImageData(filePath);
        if (imageData) {
